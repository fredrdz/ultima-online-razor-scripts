...
decorations = {
    # Christmas
    "box of snowdrops (east/west)": myItem(
        "box of snowdrops", 0x3325, 0x0000, "decoration", 1
    ),
    "box of snowdrops (north/south)": myItem(
        "box of snowdrops", 0x3326, 0x0000, "decoration", 1
    ),
    ...
    "holiday toy egg (red)": myItem(
        "holiday toy egg (red)", 0x4CFD, 0x0026, "decoration", 1
    ),
    "holiday toy egg (blue)": myItem(
        "holiday toy egg (blue)", 0x4CFD, 0x0000, "decoration", 1
    ),
    "holly jolly torch": myItem("holly jolly torch", 0x0F6B, 0x09E9, "decoration", 1),
    "marshmallow snowballs": myItem(
        "marshmallow snowballs", 0x09EB, 0x0481, "decoration", 1
    ),
    "old holiday sign (Santa's Workshop - Closed till next year)": myItem(
    ...
    "UOForever's 6th Year": myItem(
        "UOForever's 6th Year", 0x9BC8, 0x0AA1, "decoration", 1
    ),
}

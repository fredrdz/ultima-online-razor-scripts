...
miscellaneous = {
    ...
    "molten relic": myItem(
        name="molten relic", itemID=0x2AA4, color=0x0550, category="generic", weight=8
    ),
    ...
    "recall rune": myItem(
        name="recall rune", itemID=0x1F14, color=0x0000, category="generic", weight=1
    ),
    "runebook": myItem(
        name="runebook", itemID=0x22C5, color=0x0000, category="generic", weight=1
    ),
    "seer's powder": myItem(
        name="seer's powder", itemID=0x26B8, color=0x0A26, category="generic", weight=1
    ),
    "translocation powder": myItem(
        name="translocation powder",
        itemID=0x26B8,
        color=0x0000,
        category="generic",
        weight=1,

...
spellReagents = {
    # First Circle
    "Clumsy": [reagents["Blood Moss"], reagents["Nightshade"]],
    "Create Food": [reagents["Garlic"], reagents["Ginseng"], reagents["Mandrake Root"]],
    "Feeblemind": [reagents["Ginseng"], reagents["Nightshade"]],
    "Heal": [reagents["Garlic"], reagents["Ginseng"], reagents["Spider's Silk"]],
    "Magic Arrow": [reagents["Sulfurous Ash"]],
    "Night Sight": [reagents["Spider's Silk"], reagents["Sulfurous Ash"]],
    "Reactive Armor": [
        reagents["Garlic"],
        reagents["Spider's Silk"],
        reagents["Sulfurous Ash"],
    ],
    "Weaken": [reagents["Garlic"], reagents["Nightshade"]],
    # Second Circle
    "Agility": [reagents["Blood Moss"], reagents["Mandrake Root"]],
    "Cunning": [reagents["Mandrake Root"], reagents["Nightshade"]],
    "Cure": [reagents["Garlic"], reagents["Ginseng"]],
    "Harm": [reagents["Nightshade"], reagents["Spider's Silk"]],
    "Magic Trap": [
        reagents["Garlic"],
        reagents["Spider's Silk"],
        reagents["Sulfurous Ash"],
    ],
    "Magic Untrap": [reagents["Blood Moss"], reagents["Sulfurous Ash"]],
    "Protection": [reagents["Garlic"], reagents["Ginseng"], reagents["Sulfurous Ash"]],
    "Strength": [reagents["Mandrake Root"], reagents["Nightshade"]],
    # Third Circle
    "Bless": [reagents["Garlic"], reagents["Mandrake Root"]],
    "Fireball": [reagents["Black Pearl"]],
    "Magic Lock": [
        reagents["Blood Moss"],
        reagents["Garlic"],
        reagents["Sulfurous Ash"],
    ...
    "Telekinesis": [reagents["Blood Moss"], reagents["Mandrake Root"]],
    "Teleport": [reagents["Blood Moss"], reagents["Mandrake Root"]],
    "Unlock": [reagents["Blood Moss"], reagents["Sulfurous Ash"]],
    "Wall of Stone": [reagents["Blood Moss"], reagents["Garlic"]],
    # Fourth Circle
    "Arch Cure": [reagents["Garlic"], reagents["Ginseng"], reagents["Mandrake Root"]],
    "Arch Protection": [
        reagents["Garlic"],
        reagents["Ginseng"],
    ...
    "Curse": [reagents["Garlic"], reagents["Nightshade"], reagents["Sulfurous Ash"]],
    "Fire Field": [
    ...
    "Lightning": [reagents["Mandrake Root"], reagents["Sulfurous Ash"]],
    "Mana Drain": [
        reagents["Black Pearl"],
        reagents["Mandrake Root"],
        reagents["Spider's Silk"],
    ...
    "Incognito": [reagents["Blood Moss"], reagents["Garlic"], reagents["Nightshade"]],
    "Magic Reflection": [
        reagents["Garlic"],
        reagents["Mandrake Root"],
        reagents["Spider's Silk"],
    ...
    "Energy Bolt": [reagents["Black Pearl"], reagents["Nightshade"]],
    "Explosion": [reagents["Blood Moss"], reagents["Mandrake Root"]],
    "Invisibility": [reagents["Blood Moss"], reagents["Nightshade"]],
    "Mark": [
        reagents["Black Pearl"],
        reagents["Blood Moss"],
        reagents["Mandrake Root"],
    ...
    "Reveal": [reagents["Blood Moss"], reagents["Sulfurous Ash"]],
    # Seventh Circle
    "Chain Lightning": [
        reagents["Black Pearl"],
        reagents["Blood Moss"],
    ...
    "Flamestrike": [reagents["Spider's Silk"], reagents["Sulfurous Ash"]],
    "Gate Travel": [
        reagents["Black Pearl"],
        reagents["Mandrake Root"],
        reagents["Sulfurous Ash"],
    ...
    "Resurrection": [reagents["Blood Moss"], reagents["Garlic"], reagents["Ginseng"]],
...
spells = {
    ...
    "Magic Arrow": SpellInfo(
        "Magic Arrow", 1, spellReagents["Magic Arrow"], 4, 0.0, 0.5, 1000
    ),
    "Night Sight": SpellInfo(
        "Night Sight", 1, spellReagents["Night Sight"], 4, 0.0, 0.5, 500
    ),
    "Reactive Armor": SpellInfo(
        "Reactive Armor", 1, spellReagents["Reactive Armor"], 4, 0.0, 0.5, 500
    ),
    ...
    "Harm": SpellInfo("Harm", 2, spellReagents["Harm"], 6, 0.0, 0.75, 2000),
    ...
    "Protection": SpellInfo(
        "Protection", 2, spellReagents["Protection"], 6, 0.0, 0.75, 750
    ),
    ...
    "Fireball": SpellInfo("Fireball", 3, spellReagents["Fireball"], 9, 9.0, 1.0, 2350),
    "Magic Lock": SpellInfo(
        "Magic Lock", 3, spellReagents["Magic Lock"], 9, 9.0, 1.0, 1000
    ),
    "Poison": SpellInfo("Poison", 3, spellReagents["Poison"], 9, 9.0, 1.0, 2000),
    ...
    "Curse": SpellInfo("Curse", 4, spellReagents["Curse"], 11, 24.0, 1.25, 2000),
    ...
    "Lightning": SpellInfo(
        "Lightning", 4, spellReagents["Lightning"], 11, 24.0, 1.25, 2350
    ),
    ...
    "Magic Reflection": SpellInfo(
        "Magic Reflection", 5, spellReagents["Magic Reflection"], 14, 38.0, 1.5, 1500
    ),
    ...
    "Energy Bolt": SpellInfo(
        "Energy Bolt", 6, spellReagents["Energy Bolt"], 20, 52.0, 1.75, 3000
    ),
    "Explosion": SpellInfo(
        "Explosion", 6, spellReagents["Explosion"], 20, 52.0, 1.75, 3000
    ),
    ...
    "Flamestrike": SpellInfo(
        "Flamestrike", 7, spellReagents["Flamestrike"], 40, 67.0, 2.0, 3000
    ),
    ...
    "Summon Air Elemental": SpellInfo(
        "Summon Air Elemental",
        8,
        spellReagents["Summon Air Elemental"],
        50,
        81.0,
        2.25,
        2250,
    ...
    "Summon Earth Elemental": SpellInfo(
        "Summon Earth Elemental",
        8,
        spellReagents["Summon Earth Elemental"],
        50,
        81.0,
        2.25,
        2250,
    ...
    "Summon Fire Elemental": SpellInfo(
        "Summon Fire Elemental",
        8,
        spellReagents["Summon Fire Elemental"],
        50,
        81.0,
        2.25,
        2250,
    ...
    "Summon Water Elemental": SpellInfo(
        "Summon Water Elemental",
        8,
        spellReagents["Summon Water Elemental"],
        50,
        81.0,
        2.25,
        2250,

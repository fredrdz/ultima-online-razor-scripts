...
spells = {
    ...
    "Lightning": SpellInfo(
        "Lightning", 4, spellReagents["Lightning"], 11, 24.0, 1.25, 1250
    ),
    ...
    "Mind Blast": SpellInfo(
        "Mind Blast", 5, spellReagents["Mind Blast"], 14, 38.0, 1.5, 1500
    ),
    "Paralyze": SpellInfo(
    ...
    "Energy Bolt": SpellInfo(
        "Energy Bolt", 6, spellReagents["Energy Bolt"], 20, 52.0, 1.75, 1750
    ),
    "Explosion": SpellInfo(
        "Explosion", 6, spellReagents["Explosion"], 20, 52.0, 1.75, 1750
    ),
    ...
    "Flamestrike": SpellInfo(
        "Flamestrike", 7, spellReagents["Flamestrike"], 40, 67.0, 2.0, 2000
    ),
